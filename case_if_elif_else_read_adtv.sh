...
echo "enter something: "  # abo read -p(vvdeditiy shosiy) "enter something: " x
read x                    #     vveditiy shosiy "x" ce ie sho treba vvestu:
                          #     abo  1, [2-9], "igor", *) i echo "print words"
...
# read x-----vvestu shosiy v variable(x) "print something: " treba vvestu tekst iakuiy poiavutiysia na ekrani i ceiy tekst maie nalezhatu do case $x in
# case $x in-----ce treba vvestu na ekrani abo 1, [2-9],"igor",*) i todi echo "zrobutiy print iakogo tu v niomy propusav teksty na ekran"  
