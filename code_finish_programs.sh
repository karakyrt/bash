...
# 0-----this is standart vvod eto klaviatyra(most cases is keyboard) to sho tu vviv v terminal: ls
# 1-----standart vuvod eto na monitor(most cases is monitor) tosho tobi pokazala rezyliytat komandu ls(file1, file2, file3, file4)
